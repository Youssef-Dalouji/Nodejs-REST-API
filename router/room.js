...
// router.get('/queryListUsers',middlewareProtect,async(req,res)=>{
//     const idRoom=req.headers.idroom
//     let usersConnect=0
//     try{
//         const findOneRoom=await modelRoomChat.findOne({idRoom:idRoom})
//         if(findOneRoom){
//             const dataGetRoom={...findOneRoom}
//             dataGetRoom._doc.users.forEach((item)=>{
...
//         }
//     }catch(err){
//         res.status(404).json([{operation:0,message:err}])
//     }
// })
